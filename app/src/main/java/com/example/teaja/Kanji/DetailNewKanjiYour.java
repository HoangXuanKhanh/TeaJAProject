...
public class DetailNewKanjiYour extends Fragment {
    ...
    private List<KanjiN4> getList() {
        ...
        list.add(new KanjiN4(1, "Bài 1"));
        list.add(new KanjiN4(2, "Bài 2"));
        list.add(new KanjiN4(3, "Bài 3"));
        list.add(new KanjiN4(4, "Bài 4"));
        list.add(new KanjiN4(5, "Bài 5"));
        list.add(new KanjiN4(6, "Bài 6"));
        list.add(new KanjiN4(7, "Bài 7"));
        list.add(new KanjiN4(8, "Bài 8"));
        list.add(new KanjiN4(9, "Bài 9"));
        list.add(new KanjiN4(10, "Bài 10"));
        list.add(new KanjiN4(11, "Bài 11"));
        list.add(new KanjiN4(12, "Bài 12"));
        list.add(new KanjiN4(13, "Bài 13"));
        list.add(new KanjiN4(14, "Bài 14"));
        list.add(new KanjiN4(15, "Bài 15"));
        list.add(new KanjiN4(16, "Bài 16"));
        list.add(new KanjiN4(17, "Bài 17"));
        list.add(new KanjiN4(18, "Bài 18"));
        list.add(new KanjiN4(19, "Bài 19"));
        list.add(new KanjiN4(20, "Bài 20"));
        list.add(new KanjiN4(21, "Bài 21"));
        list.add(new KanjiN4(22, "Bài 22"));
        list.add(new KanjiN4(23, "Bài 23"));
        list.add(new KanjiN4(24, "Bài 24"));
        list.add(new KanjiN4(25, "Bài 25"));
