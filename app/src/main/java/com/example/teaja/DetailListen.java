...
public class DetailListen extends AppCompatActivity {
    private BottomNavigationView bottomNavigationView;
    private ViewPager mPagerListen;
    private Toolbar tlBackLisTen;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_listen);
        tlBackLisTen = findViewById(R.id.Tool_ComeBackLISTeN);
        bottomNavigationView = findViewById(R.id.btn_NavgationNghe);
        mPagerListen = findViewById(R.id.vpg_Nghe);

        setUpViewPagerListen();
        setSupportActionBar(tlBackLisTen);
    ...
    private void setUpViewPagerListen() {
        ViewPagerListen viewPagerListen = new ViewPagerListen(getSupportFragmentManager(), FragmentStatePagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT);
        mPagerListen.setAdapter(viewPagerListen);
        mPagerListen.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            @Override
